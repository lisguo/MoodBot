...
public class MoodBotView {
	...
	primaryStage.setHeight(bounds.getHeight());
        ...
        startChat = new Button("Login");
        startChat.getStyleClass().add("menu_button");
        menuButtons.getChildren().addAll(email, emailField, password, passwordField,startChat);
    ...
    public void restartUI(Stage primaryStage, String windowTitle){
        primaryStage.setTitle(windowTitle);
